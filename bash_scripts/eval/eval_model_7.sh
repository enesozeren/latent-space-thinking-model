...
#SBATCH -o bash_outputs/output_eval_7.log
#SBATCH -e bash_outputs/error_eval_7.log
...
CONFIG_PATH="src/configs/latent_rl/latent_reasoner_sft_latent_rl_eval_gsm.yaml"
