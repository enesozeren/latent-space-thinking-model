...
#SBATCH -o bash_outputs/output_eval_8.log
#SBATCH -e bash_outputs/error_eval_8.log
...
CONFIG_PATH="src/configs/latent_rl/latent_reasoner_sft_latent_rl_eval_math.yaml"
