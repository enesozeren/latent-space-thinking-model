...
SYSTEM_PROMPT_LATENT_REASONER_THINK=r"""
A conversation between User and Assistant. The user asks a question, and the Assistant solves it. 
...
SYSTEM_PROMPT_LATENT_REASONER_NO_THINK=r"""
A conversation between User and Assistant. The user asks a question, and the Assistant solves it. 
The assistant first thinks about the reasoning process in the latent-space without using language.
Then it provides the user with the reasoning in latent-space and the answer. 
The reasoning in latent-space and answer are enclosed within <|start-latent|> <|end-latent|> and <answer> </answer> tags, respectively and the answer is boxed using \boxed{...}.
Output only those two tagged blocks, in that order, nothing else.
i.e., <|start-latent|>reasoning in latent here<|end-latent|><answer>\boxed{...}</answer>
"""
...
# SYSTEM_PROMPT_LATENT_REASONER_GSM8K_1_SHOT_EVAL = SYSTEM_PROMPT_LATENT_REASONER_THINK + GSM8K_1_SHOT_EVAL
...
# SYSTEM_PROMPT_LATENT_REASONER_MATH500_1_SHOT_EVAL = SYSTEM_PROMPT_LATENT_REASONER_THINK + MATH500_1_SHOT_EVAL
